...
namespace SDA_DBMS_Project
{
    public partial class Lovely : Form
    {
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if (currentButton != (Button)btnSender)
                {
                    ...
                    currentButton.Font = new System.Drawing.Font("Segoe UI", 9.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        {
            //btnEmployee 
            OpenChildForm(new Forms.FormEmployeeManagement(), sender);
        }
        ...
        {
            //btnPprocessing
            OpenChildForm(new Forms.FormPayrollProcessing(), sender);
        }
