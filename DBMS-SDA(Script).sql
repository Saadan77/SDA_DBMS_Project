...
--    SET @HoursWorked = DATEDIFF(MINUTE, @TimeIn, @TimeOut) / 60.0;

--    INSERT INTO PayrollAttendance (EmployeeID, AttendanceID, AttendanceDate, TimeIn, TimeOut, HoursWorked)
--    VALUES (@EmployeeID, @AttendanceID, @AttendanceDate, @TimeIn, @TimeOut, @HoursWorked);
--END;
...
--    @Position = 'Student',
--    @JoinDate = '2023-06-20',
--    @TotalWorkingHours = 45.5,
--    @AverageAttendanceHours = 40.2;
